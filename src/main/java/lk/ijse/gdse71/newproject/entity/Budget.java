package lk.ijse.gdse71.newproject.entity;
...
public class Budget implements Serializable {
    ...
    public Budget(String budgetId, String projectId, String currency, double totalAmount, double allocateAmount, double spendAmount) {
